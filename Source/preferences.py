...
def prf():
	...
	def bf(opt):
		state.bfr = opt
	def adddict():
		dicttoadd = dialogs.openfileget(prompttext = 'Email Dictionary File: ', filetypes = (('Text Files', '*.txt'),))
		if dicttoadd:
	...
	def changepyexec():
		...
		fn = dialogs.openfileget(prompttext = 'New Python Executable: ', filetypes = (('All Files', '*'),))
		if fn:
