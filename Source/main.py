...
state.hmm.add_command(label = 'Normal → Alt + X - hmode:norm', command = lambda: pchmode('normal'))
state.hmm.add_command(label = 'Python → Alt + X - hmode:py', command = lambda: pchmode('python'))
