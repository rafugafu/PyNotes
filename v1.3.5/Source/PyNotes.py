...
def changes(event = None):
    ...
    cw.text(master = cw_, text = '1. Made LaTeX editing much much better!\nNow you just click on buttons and type a little bit.\nThere is no need to remember any commands.').grid(column = 0, row = 0, sticky = 'w')
    cw.text(master = cw_, text = '2. Added a new command \'pyshell\' or \'ps\' to Alt-X to open the python shell\nwhen you are in Python mode').grid(column = 0, row = 1, sticky = 'w')
...
tabs.add(sf, text = 'Python Shell', state = 'disabled')
tabs.pack(padx = 10, pady = 10, fill = 'both', expand = True)
