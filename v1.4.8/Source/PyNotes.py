...
try:
	...
	ans = ask('Error!', 'The modules were not installed properly. Do you want to quit PyNotes?\nWARNING: It is not recommended to continue at this point as many things may not work.')
	if ans:
		exit()
root = easytk.win()
...
def changes(event = None):
	...
	cw.text(master = cw_, text = '1. Improved the syntax highlighting a bit.').grid(column = 0, row = 0, sticky = 'w')
	cw.text(master = cw_, text = '2. There are a few changes in Easytk:\nThe \'ice\', \'fire\', and \'acid\' themes have been replaced by\n\'breeze\' from ttkthemes.').grid(column = 0, row = 1, sticky = 'w')
