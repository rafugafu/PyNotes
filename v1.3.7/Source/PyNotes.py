...
def changes(event = None):
	...
	cw.text(master = cw_, text = '1. Added a Letter Invaders game!\n(Start with Game → New Game or Alt+X - \'game\' command or PyCode → \'game\' command)').grid(column = 0, row = 0, sticky = 'w')
	cw.text(master = cw_, text = '2. Added graphical coding in PyCode!\n(See Help → Help with PyCode)').grid(column = 0, row = 1, sticky = 'w')
...
def pcread():
	global root
	pycodecommands = ['wait', 'quit', 'say', 'command', 'selall', 'copy', 'paste', 'ask', 'cut', 'term', 'cmd', 'undo', 'redo', 'termexec', 'game']
	pythoncommands = ['time.sleep', 'root.destroy()', 'say', 'cmd()', 'selall()', 'cp()', 'pst()', 'ask', 'cut()', 'term()', 'cmdrun', 'undo()', 'redo()', 'termexec', 'game()']
...
def pc(event = None):
	...
	commands = ['wait', 'quit', 'say', 'command', 'selall', 'copy', 'paste', 'ask', 'cut', 'term', 'cmd', 'undo', 'redo', 'termexec', 'game', 'Done']
	buttons = []
	commandtodo = []
	commanddone = []
...
def helppycode():
	...
	root.image(master = gt, image = 'PYCODE1.png', imsize = (2, 2)).grid(column = 0, row = 1, padx = 10, pady = 10)
	root.image(master = gt, image = 'PYCODE2.png', imsize = (2, 2)).grid(column = 1, row = 1, padx = 10, pady = 10)
