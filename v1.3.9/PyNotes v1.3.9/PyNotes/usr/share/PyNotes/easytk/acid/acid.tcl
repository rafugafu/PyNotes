# acid.tcl --
# acid pixmap theme for PyNotes
package require Tk 8.5.0

namespace eval ttk::theme::acid {

    variable version 0.6
    package provide ttk::theme::acid $version
    ...
    LoadImages [file join [file dirname [info script]] acid]

    ttk::style theme create acid -parent default -settings {
        ttk::style configure . \
