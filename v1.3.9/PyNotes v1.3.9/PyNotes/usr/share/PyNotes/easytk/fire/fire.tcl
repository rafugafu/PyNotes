# fire.tcl --
# fire pixmap theme for PyNotes
package require Tk 8.5.0

namespace eval ttk::theme::fire {

    variable version 0.6
    package provide ttk::theme::fire $version
    ...
    LoadImages [file join [file dirname [info script]] fire]

    ttk::style theme create fire -parent default -settings {
        ttk::style configure . \
       ...
       ttk::style element create Notebook.client \
        ...
        ttk::style element create Horizontal.Progressbar.trough \
            image $I(progressbar-horizontal-back) -border {6 0 6 0} -sticky ew
        ttk::style element create Horizontal.Progressbar.pbar \
            image $I(progressbar-horizontal) -border {6 0 6 0} -sticky ew
