...
namespace eval ttk::theme::ice {

    variable version 0.6
    package provide ttk::theme::ice $version
    ...
    LoadImages [file join [file dirname [info script]] ice]

    ttk::style theme create ice -parent default -settings {
        ttk::style configure . \
