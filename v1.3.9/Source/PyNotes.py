...
def changes(event = None):
	...
	cw.text(master = cw_, text = '1. The outputs of MathGod are now in proper format!').grid(column = 0, row = 0, sticky = 'w')
	cw.text(master = cw_, text = '2. Improved the help for MathGod.').grid(column = 0, row = 1, sticky = 'w')
