...
def changes(event = None):
    ...
    cw.text(master = cw_, text = '1. Added functions to PyCode!').grid(column = 0, row = 0, sticky = 'w')
    cw.text(master = cw_, text = '2. Added startup code to PyCode!').grid(column = 0, row = 1, sticky = 'w')
    cw.text(master = cw_, text = '3. Added a new PyCode and Alt-X command \'termexec\'.').grid(column = 0, row = 2, sticky = 'w')
    cw.text(master = cw_, text = '4. Added a new PyCode command \'wait\'.').grid(column = 0, row = 3, sticky = 'w')
    cw.text(master = cw_, text = '5. Fixed a few bugs.').grid(column = 0, row = 4, sticky = 'w')
