...
def changes(event = None):
    ...
    cw.text(master = cw_, text = '1. Greatly improved terminal').grid(column = 0, row = 0, sticky = 'w')
    cw.text(master = cw_, text = '2. PyNotes can now open e-book files!').grid(column = 0, row = 1, sticky = 'w')
    cw.text(master = cw_, text = '3. Added a proper man page for PyNotes').grid(column = 0, row = 2, sticky = 'w')
