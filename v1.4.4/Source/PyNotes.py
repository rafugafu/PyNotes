...
def changes(event = None):
	...
	cw.text(master = cw_, text = '1. Made the preferences much better! (Check Preferences → Theme & Font)\nYou can now competely customize the syntax highlighting.').grid(column = 0, row = 0, sticky = 'w')
