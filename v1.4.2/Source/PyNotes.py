...
def changes(event = None):
	...
	cw.text(master = cw_, text = '1. Added auto-indenting to python editing! (Open Preferences → Use spaces instead of tabs to use spaces instead of tabs.)').grid(column = 0, row = 0, sticky = 'w')
	cw.text(master = cw_, text = '2. Added a new command \'indent-region\' or \'ir\'. Indents the selected text.').grid(column = 0, row = 1, sticky = 'w')
	cw.text(master = cw_, text = '3. Fixed a few bugs.').grid(column = 0, row = 2, sticky = 'w')
