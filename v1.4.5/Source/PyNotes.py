...
def changes(event = None):
	...
	cw.text(master = cw_, text = '1. Added ChessPy to PyNotes! (ChessPy → Start or Alt-X → chess)').grid(column = 0, row = 0, sticky = 'w')
...
def ha(ft):
	try:
		...
		root.error('Error!', 'Invalid colour settings.\nQuitting syntax highlighting.')
