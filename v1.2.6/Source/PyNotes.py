...
def changes(event = None):
    ...
    cw.text(master = cw_, text = '1. Used subwindows for preferences, help, etc... windows.').grid(column = 0, row = 0, sticky = 'w')
    cw.text(master = cw_, text = '2. \'--version\' option from the terminal now works.').grid(column = 0, row = 1, sticky = 'w')
    cw.text(master = cw_, text = '3. A few other things').grid(column = 0, row = 2, sticky = 'w')
