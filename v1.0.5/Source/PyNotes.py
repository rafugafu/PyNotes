...
def changes(event = None):
	...
	cw.text(master = cw_, text = '1. Added detection of file type and syntax highlighting!\nIt now supports:').grid(column = 0, row = 0, sticky = 'w')
	cw.text(master = cw_, text = '    a. Python Files').grid(column = 0, row = 1, sticky = 'w')
	cw.text(master = cw_, text = '    b. LaTeX files').grid(column = 0, row = 2, sticky = 'w')
	cw.text(master = cw_, text = '    c. Plain Text files').grid(column = 0, row = 3, sticky = 'w')
	cw.text(master = cw_, text = '2. Added the bar below the editor').grid(column = 0, row = 4, sticky = 'w')
	cw.text(master = cw_, text = '3. Much improved all the warnings').grid(column = 0, row = 5, sticky = 'w')
