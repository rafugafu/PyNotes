...
def saydonestuff():
	...
	root.info('Results', f'Speed: {ttspdn}\nAccuracy: {ttaccn}%\nNumber of Characters Typed: {typed}\n{say}')
def counttt():
	global ttcountn
	global ttcountid
	global typed
