...
root.button(master = buttonframe, text = '+', command = newcell).grid(sticky = 'w', column = 0, row = 0, padx = 10, pady = 10)
root.button(master = buttonframe, text = '-', command = delete).grid(sticky = 'w', column = 1, row = 0, padx = 10, pady = 10)
root.button(master = buttonframe, text = 'Save', command = save).grid(sticky = 'w', column = 2, row = 0, padx = 10, pady = 10)
root.button(master = buttonframe, text = 'Load', command = load).grid(sticky = 'w', column = 3, row = 0, padx = 10, pady = 10)
inputentries = {}
inputtexts = {}
outputboxes = {}
outputtexts = {}
