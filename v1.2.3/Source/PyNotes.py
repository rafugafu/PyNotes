...
def changes(event = None):
    ...
    cw.text(master = cw_, text = '1. Finally added proper expanding to the window!').grid(column = 0, row = 0, sticky = 'w')
    cw.text(master = cw_, text = '2. Improved the shell').grid(column = 0, row = 1, sticky = 'w')
    cw.text(master = cw_, text = '3. Fixed jittery line numbering in the editor').grid(column = 0, row = 2, sticky = 'w')
...
type_.pack(fill = 'both', expand = True)
type_.insert('end',
