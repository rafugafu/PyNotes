...
def changes(event = None):
	...
	cw.text(master = cw_, text = '1. Added saving and loading of notebooks to MathGod!').grid(column = 0, row = 0, sticky = 'w')
	cw.text(master = cw_, text = '2. Fixed the bug where PyNotes was completely unresponsive\nwhile MathGod was running.').grid(column = 0, row = 1, sticky = 'w')
...
def helppycode():
	...
	root.image(master = gt, image = '/usr/share/PyNotes/Images/PYCODE1.png', imsize = (2, 2)).grid(column = 0, row = 1, padx = 10, pady = 10)
	root.image(master = gt, image = '/usr/share/PyNotes/Images/PYCODE2.png', imsize = (2, 2)).grid(column = 1, row = 1, padx = 10, pady = 10)
...
def helpmathgod():
	...
	root.image(master = func, image = '/usr/share/PyNotes/Images/plotim.png', imsize = (3, 3)).grid(column = 1, row = 1, padx = 10, pady = 10)
	root.image(master = func, image = '/usr/share/PyNotes/Images/plotim2.png', imsize = (3, 3)).grid(column = 1, row = 2, padx = 10, pady = 10)
	eq = hmgwin.frame()
	...
	root.image(master = plt2, image = '/usr/share/PyNotes/Images/plotim.png', imsize = (3, 3)).grid(column = 2, row = 1, padx = 10, pady = 10)
	...
	root.image(master = plt2, image = '/usr/share/PyNotes/Images/plotim3.png', imsize = (3, 3)).grid(column = 2, row = 2, padx = 10, pady = 10)
	...
	root.image(master = plt2, image = '/usr/share/PyNotes/Images/plotim4.png', imsize = (3, 3)).grid(column = 2, row = 3, padx = 10, pady = 10)
	root.image(master = plt2, image = '/usr/share/PyNotes/Images/plotim5.png', imsize = (3, 3)).grid(column = 2, row = 3, padx = 10, pady = 10)
	...
	root.image(master = pltpie, image = '/usr/share/PyNotes/Images/plotim6.png', imsize = (3, 3)).grid(column = 1, row = 1, padx = 10, pady = 10)
	root.image(master = pltpie, image = '/usr/share/PyNotes/Images/plotim7.png', imsize = (3, 3)).grid(column = 1, row = 2, padx = 10, pady = 10)
	pltbar = hmgwin.frame()
	...
	root.image(master = pltbar, image = '/usr/share/PyNotes/Images/plotim8.png', imsize = (3, 3)).grid(column = 1, row = 1, padx = 10, pady = 10)
	...
	root.image(master = pltbar, image = '/usr/share/PyNotes/Images/plotim9.png', imsize = (3, 3)).grid(column = 1, row = 2, padx = 10, pady = 10)
	plt3 = hmgwin.frame()
	...
	root.image(master = plt3, image = '/usr/share/PyNotes/Images/plotim10.png', imsize = (3, 3)).grid(column = 1, row = 1, padx = 10, pady = 10)
	sum = hmgwin.frame()
	...
	root.image(master = intp, image = '/usr/share/PyNotes/Images/plotim11.png', imsize = (3, 3)).grid(column = 1, row = 1, padx = 10, pady = 10)
	cnd = hmgwin.frame()
