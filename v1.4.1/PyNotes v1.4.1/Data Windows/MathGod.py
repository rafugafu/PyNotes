...
def ha():
	...
	for entry in inputentries.items():
		...
		for search in searchs:
			...
			if colour == 'bold':
				entry.tag_config(tags[searchs.index(search)], font = ('Courier', 12, 'bold'), foreground = 'purple')
			else:
...
def newcell():
	...
	output = root.textbox(state = 'disabled', height = 1, font = ('Courier', 12))
	...
	entry = root.textbox(height = 1, font = ('Courier', 12))
