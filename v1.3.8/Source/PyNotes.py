...
def changes(event = None):
	...
	cw.text(master = cw_, text = '1. Added MathGod! (See Help → Help with MathGod)').grid(column = 0, row = 0, sticky = 'w')
	cw.text(master = cw_, text = '2. Added a new Alt-X command: \'mathgod\' or \'mg\', and\na new PyCode command \'mathgod\'.').grid(column = 0, row = 1, sticky = 'w')
...
def helpmathgod():
	...
	root.image(master = pltpie, image = '/usr/share/PyNotes/plotim5.png', imsize = (3, 3)).grid(column = 1, row = 1, padx = 10, pady = 10)
	root.image(master = pltpie, image = '/usr/share/PyNotes/plotim6.png', imsize = (3, 3)).grid(column = 1, row = 2, padx = 10, pady = 10)
	pltbar = hmgwin.frame()
	...
	root.image(master = pltbar, image = '/usr/share/PyNotes/plotim7.png', imsize = (3, 3)).grid(column = 1, row = 1, padx = 10, pady = 10)
	...
	root.image(master = pltbar, image = '/usr/share/PyNotes/plotim8.png', imsize = (3, 3)).grid(column = 1, row = 2, padx = 10, pady = 10)
	plt3 = hmgwin.frame()
	...
	root.image(master = plt3, image = '/usr/share/PyNotes/plotim9.png', imsize = (3, 3)).grid(column = 1, row = 1, padx = 10, pady = 10)
	sum = hmgwin.frame()
	...
	root.image(master = intp, image = '/usr/share/PyNotes/plotim10.png', imsize = (3, 3)).grid(column = 1, row = 1, padx = 10, pady = 10)
	cnd = hmgwin.frame()
